...
export default async function ProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const lazogluShowcaseImages = [
    { id: "lazoglu-anasayfa", type: "desktop" as const, label: "1. Ana Sayfa Karşılama (Masaüstü Hero)", shortLabel: "1. Ana Sayfa", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/lazoglukuruyemis-anasayfa-masaustu.png", alt: "Lazoğlu Kuruyemiş ana sayfa masaüstü karşılama ekranı", width: 1917, height: 908 },
    { id: "lazoglu-urunler", type: "desktop" as const, label: "2. Ürün Kataloğu & Kategoriler (Masaüstü)", shortLabel: "2. Ürünler", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/lazoglukuruyemis-urunler-masaustu.png", alt: "Lazoğlu Kuruyemiş ürün kataloğu ve kategori filtreleme ekranı", width: 1917, height: 910 },
    { id: "lazoglu-hakkimizda", type: "desktop" as const, label: "3. Hakkımızda & Çorum Hikayesi (Masaüstü)", shortLabel: "3. Hakkımızda", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/lazoglukuruyemis-hakkimizda-masaustu.png", alt: "Lazoğlu Kuruyemiş hakkımızda ve Çorum hikayesi sayfası", width: 1917, height: 912 },
    { id: "lazoglu-blog", type: "desktop" as const, label: "4. Blog & İçerik Sayfası (Masaüstü)", shortLabel: "4. Blog", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/lazoglukuruyemis-blog-masaustu.jpg", alt: "Lazoğlu Kuruyemiş blog ve içerik sayfası", width: 1440, height: 2200 },
    { id: "lazoglu-iletisim", type: "desktop" as const, label: "5. İletişim & Mağaza Bilgileri (Masaüstü)", shortLabel: "5. İletişim", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/lazoglukuruyemis-iletisim-masaustu.jpg", alt: "Lazoğlu Kuruyemiş iletişim ve mağaza bilgileri sayfası", width: 1440, height: 1370 },
    { id: "lazoglu-mobil", type: "mobile" as const, label: "6. Mobil Alışveriş Deneyimi (Mobil)", shortLabel: "6. Mobil Görünüm", badge: "Mobil Öncelikli / 390px", icon: "📱", url: "/gorseller/referanslar/lazoglukuruyemis-mobil.jpg", alt: "Lazoğlu Kuruyemiş mobil alışveriş deneyimi", width: 375, height: 2600 },
  ];

  const fkKuruyemisShowcaseImages = [
    { id: "fk-anasayfa", type: "desktop" as const, label: "1. Ana Sayfa Karşılama (Masaüstü Hero)", shortLabel: "1. Ana Sayfa", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/fkkuruyemis-anasayfa-masaustu.png", alt: "FK Kuruyemiş ana sayfa masaüstü karşılama ekranı", width: 1917, height: 906 },
    { id: "fk-urunler", type: "desktop" as const, label: "2. Ürün Kataloğu & Leblebi Çeşitleri (Masaüstü)", shortLabel: "2. Ürünler", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/fkkuruyemis-urunler-masaustu.png", alt: "FK Kuruyemiş ürün kataloğu ve leblebi çeşitleri ekranı", width: 1917, height: 907 },
    { id: "fk-hakkimizda", type: "desktop" as const, label: "3. Hakkımızda & Çorum Leblebi Kültürü (Masaüstü)", shortLabel: "3. Hakkımızda", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/fkkuruyemis-hakkimizda-masaustu.jpg", alt: "FK Kuruyemiş hakkımızda ve Çorum leblebi kültürü sayfası", width: 1440, height: 1780 },
    { id: "fk-blog", type: "desktop" as const, label: "4. Blog & İçerik Sayfası (Masaüstü)", shortLabel: "4. Blog", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/fkkuruyemis-blog-masaustu.png", alt: "FK Kuruyemiş blog ve içerik sayfası", width: 1917, height: 911 },
    { id: "fk-iletisim", type: "desktop" as const, label: "5. İletişim & Sipariş Bilgileri (Masaüstü)", shortLabel: "5. İletişim", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/fkkuruyemis-iletisim-masaustu.jpg", alt: "FK Kuruyemiş iletişim ve sipariş bilgileri sayfası", width: 1440, height: 1380 },
    { id: "fk-mobil", type: "mobile" as const, label: "6. Mobil Alışveriş Deneyimi (Mobil)", shortLabel: "6. Mobil Görünüm", badge: "Mobil Öncelikli / 390px", icon: "📱", url: "/gorseller/referanslar/fkkuruyemis-mobil.jpg", alt: "FK Kuruyemiş mobil alışveriş deneyimi", width: 375, height: 2600 },
  ];

  const millwalShowcaseImages = [
    { id: "millwal-anasayfa", type: "desktop" as const, label: "1. Ana Sayfa Karşılama (Masaüstü Hero)", shortLabel: "1. Ana Sayfa", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/millwallkurumsalkiralama-anasayfa-masaustu.png", alt: "Millwal Kurumsal Kiralama ana sayfa masaüstü karşılama ekranı", width: 1917, height: 912 },
    { id: "millwal-araclar", type: "desktop" as const, label: "2. Araç Filosu & Kiralama Seçenekleri (Masaüstü)", shortLabel: "2. Araçlar", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/millwallkurumsalkiralama-araclar-masaustu.png", alt: "Millwal Kurumsal Kiralama araç filosu ve kiralama seçenekleri ekranı", width: 1911, height: 908 },
    { id: "millwal-kurumsal", type: "desktop" as const, label: "3. Kurumsal Kiralama Çözümleri (Masaüstü)", shortLabel: "3. Kurumsal", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/millwallkurumsalkiralama-kurumsal-masaustu.jpg", alt: "Millwal Kurumsal Kiralama kurumsal kiralama çözümleri sayfası", width: 1440, height: 1600 },
    { id: "millwal-filo", type: "desktop" as const, label: "4. Filo Kiralama Hizmetleri (Masaüstü)", shortLabel: "4. Filo Kiralama", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/millwallkurumsalkiralama-filokiralama-masaustu.jpg", alt: "Millwal Kurumsal Kiralama filo kiralama hizmetleri sayfası", width: 1440, height: 860 },
    { id: "millwal-iletisim", type: "desktop" as const, label: "5. İletişim & Teklif Formu (Masaüstü)", shortLabel: "5. İletişim", badge: "Geniş Ekran / 1440px", icon: "💻", url: "/gorseller/referanslar/millwallkurumsalkiralama-iletisim-masaustu.png", alt: "Millwal Kurumsal Kiralama iletişim ve teklif formu sayfası", width: 1917, height: 911 },
    { id: "millwal-mobil", type: "mobile" as const, label: "6. Mobil Araç Kiralama Deneyimi (Mobil)", shortLabel: "6. Mobil Görünüm", badge: "Mobil Öncelikli / 390px", icon: "📱", url: "/gorseller/referanslar/millwallkurumsalkiralama-mobil.jpg", alt: "Millwal Kurumsal Kiralama mobil araç kiralama deneyimi", width: 325, height: 2000 },
  ];
